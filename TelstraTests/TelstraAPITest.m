...
@property TFactResponse *TfactsResponseManger;
@end
...
- (void)setUp {
    ...
    _TfactsResponseManger = [[TFactResponse alloc] init];
}
...
- (void)testFactsAPIConnection {
    ...
    [_TfactsResponseManger getFactsDataWithCompletionHandler:^(NSError *error) {
